...
## Neodent Mobile App [project:neodent mobile app] [release:mthm1jxi_tpicbj]
Status: Teste
...
## ClearCorrect Automations [project:clearcorrect automations] [release:mthm1jxi_zgkny3]
...
## Genia Mobile App [project:genia mobile app] [release:mthm1jxi_rmrfpm]
Status: Desenvolvimento
...
## Genia Web App [project:genia web app] [release:mthm1jxi_90yg87]
Status: Teste
...
## ClearWallet [project:clearwallet] [release:mthm1jxi_rcfh9s]
Status: Desenvolvimento
Start Date: 2026-06-15
...
## Mapping [project:mapping] [release:mthm1jxi_nvg47g]
Status: Bloqueado
tão enrolando
...
## Outros [project:outros] [release:mthm1jxi_v44kgu]
...
## Clear Mobile App [project:clear mobile app] [release:mthm1jxi_d6y1ng]
Status: Desenvolvimento
...
## Hub [project:global hub] [release:mthm1jxi_qg5rra]
Status: Teste
Start Date: 2026-06-01
Delivery Date: 2026-07-03
...
## Gerenciador CC [project:gerenciador cc] [release:mthm1jxi_664n3p]
Status: Bloqueado

- [ ] Fluxos de dados (Fel) [AREA: Data] [BLOCKED: rly?] [FOLLOWED]

## Kit Resgate [project:kit recuperacao] [release:mthm1jxi_ve2huh]
Status: Teste
...
## Digital Connect [project:digital connect] [release:mthm1jxi_hodau5]
Status: Bloqueado
...
## Apresentações [project:internal projects] [release:mthm1jxi_31th8s]
Status: Desenvolvimento
Start Date: 2026-06-15
Delivery Date: 2026-07-03
...
## ClearPilot [project:clearpilot] [release:mthm1jxi_7nmogx]
Status: Desenvolvimento
Start Date: 2026-06-08
...
## Digital -> Genia Mobile App [project:genia mobile app] [release:mthm1jxj_jwygag]
Status: Desenvolvimento
...
## Acordo Partner [project:digital connect] [release:mthm1jxj_s7enhc]
Status: Bloqueado
...
## Genia Geral [project:genia mobile app] [release:mthm1jxj_rajcq3]
Status: Planejamento
