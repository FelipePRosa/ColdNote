...
## OTB [project:otb] [release:mthm1jxb_8kjb76]
Status: Teste
...
## Hub [project:global hub] [release:mthm1jxb_8kcgv8]
Status: Teste

- [x] Revisar funcionalidades (Bruf + Maxo + Nu)

## Genia Web App [project:genia web app] [release:mthm1jxb_qit0bv]
Status: Teste
Hj tão de boa
...
## ClearWallet [project:clearwallet] [release:mthm1jxb_xahngj]
Status: Planejamento
...
## Mapping [project:mapping] [release:mthm1jxb_abhr8q]
...
## Kit Resgate [project:kit recuperacao] [release:mthm1jxb_da2caw]
Status: Teste
...
## Neodent Mobile App [project:neodent mobile app] [release:mthm1jxb_o69e63]
Status: Teste

- [x] Dev Data Wakeword (Brunin + Hary)

## Genia Mobile App [project:genia mobile app] [release:mthm1jxb_ukd87j]
Status: Teste
...
## ClearCorrect Automations [project:clearcorrect automations] [release:mthm1jxb_xwbu9v]
...
## Outros [project:outros] [release:mthm1jxb_6jnwia]
Status: Acompanhamento
...
## Clear Mobile App [project:clear mobile app] [release:mthm1jxb_mchycq]
Status: Planejamento
