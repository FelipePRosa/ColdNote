...
## Neodent Mobile App [project:neodent mobile app] [release:mthm1jxh_mbbi71]
Status: Teste
...
## ClearCorrect Automations [project:clearcorrect automations] [release:mthm1jxh_c2jssa]
...
## Genia Mobile App [project:genia mobile app] [release:mthm1jxh_ltlpgm]
Status: Desenvolvimento
...
## Genia Web App [project:genia web app] [release:mthm1jxh_90gn4l]
Status: Teste
...
## ClearWallet [project:clearwallet] [release:mthm1jxh_6xkcpf]
Status: Desenvolvimento
Start Date: 2026-06-15
...
## Mapping [project:mapping] [release:mthm1jxh_te21o2]
Status: Bloqueado
tão enrolando
...
## Outros [project:outros] [release:mthm1jxh_m0mw5n]
...
## Clear Mobile App [project:clear mobile app] [release:mthm1jxh_4fegna]
Status: Desenvolvimento
...
## Hub [project:global hub] [release:mthm1jxh_nys0e9]
Status: Teste
Start Date: 2026-06-01
Delivery Date: 2026-07-03
...
## Gerenciador CC [project:gerenciador cc] [release:mthm1jxh_shtcuo]
Status: Bloqueado

- [ ] Fluxos de dados (Fel) [AREA: Data] [BLOCKED: rly?] [FOLLOWED]

## Kit Resgate [project:kit recuperacao] [release:mthm1jxh_znnv2c]
Status: Teste
...
## Digital Connect - 1ª etapa [project:digital connect] [release:mthm1jxh_op81bu]
Status: Planejamento
...
## Digital Connect - 2ª etapa [project:digital connect] [release:mthm1jxh_fpbeoe]
Status: Bloqueado
...
## Digital -> Genia Mobile App [project:genia mobile app] [release:mthm1jxh_ctsu8a]
Status: Desenvolvimento
...
## Acordo Partner [project:digital connect] [release:mthm1jxh_5i1n8n]
Status: Planejamento
Start Date: 2026-07-20
Delivery Date: 2026-08-07
...
## Testes Automáticos [project:internal projects] [release:mthm1jxh_j1dtd2]
Status: Desenvolvimento
Start Date: 2026-06-15
Delivery Date: 2026-07-03
...
## Genia Geral [project:genia mobile app] [release:mthm1jxh_67cgnj]
Status: Planejamento
...
## ClearPilot [project:clearpilot] [release:mthm1jxh_pjzr72]
Status: Desenvolvimento
Start Date: 2026-06-08
